...
class Etabs:
    ...
    def __init__(self, path: Path | None, modelo_nuevo: bool = False, cerrar_intancia_abierta: bool = True) -> None:
    ...
    def cerrar_modelo(self) -> None:
        """Cerrar modelo."""
        self.etabs_object.ApplicationExit(True)  # llave true es para guardar antes de salir
